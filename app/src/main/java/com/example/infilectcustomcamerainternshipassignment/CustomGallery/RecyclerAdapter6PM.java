...
public class RecyclerAdapter6PM extends RecyclerView.Adapter<RecyclerAdapter6PM.TimeViewHolder>{
    ...
    public RecyclerAdapter6PM(List<UserModel> userModelList, Context context, String stringHour) {
