...
public class RecyclerAdapter10PM extends RecyclerView.Adapter<RecyclerAdapter10PM.TimeViewHolder>{
    ...
    public RecyclerAdapter10PM(List<UserModel> userModelList, Context context, String stringHour) {
