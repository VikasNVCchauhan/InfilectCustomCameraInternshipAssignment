...
public class RecyclerAdapter4AM extends RecyclerView.Adapter<RecyclerAdapter4AM.TimeViewHolder>{
    ...
    public RecyclerAdapter4AM(List<UserModel> userModelList, Context context, String stringHour) {
