...
public class RecyclerAdapter3PM extends RecyclerView.Adapter<RecyclerAdapter3PM.TimeViewHolder>{
    ...
    public RecyclerAdapter3PM(List<UserModel> userModelList, Context context, String stringHour) {
