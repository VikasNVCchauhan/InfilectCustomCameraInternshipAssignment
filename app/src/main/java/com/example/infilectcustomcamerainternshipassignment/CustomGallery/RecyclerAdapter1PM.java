...
public class RecyclerAdapter1PM extends RecyclerView.Adapter<RecyclerAdapter1PM.TimeViewHolder>{
    ...
    public RecyclerAdapter1PM(List<UserModel> userModelList, Context context, String stringHour) {
