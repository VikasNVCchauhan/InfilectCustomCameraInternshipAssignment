...
public class RecyclerAdapter3AM extends RecyclerView.Adapter<RecyclerAdapter3AM.TimeViewHolder>{
    ...
    public RecyclerAdapter3AM(List<UserModel> userModelList, Context context, String stringHour) {
