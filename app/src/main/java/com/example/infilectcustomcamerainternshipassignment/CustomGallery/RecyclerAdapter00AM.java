...
public class RecyclerAdapter00AM extends RecyclerView.Adapter<RecyclerAdapter00AM.TimeViewHolder> {
    ...
    public RecyclerAdapter00AM(List<UserModel> userModelList, Context context, String stringHour) {
