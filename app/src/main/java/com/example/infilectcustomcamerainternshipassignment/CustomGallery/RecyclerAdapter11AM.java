...
public class RecyclerAdapter11AM extends RecyclerView.Adapter<RecyclerAdapter11AM.TimeViewHolder>{
    ...
    public RecyclerAdapter11AM(List<UserModel> userModelList, Context context, String stringHour) {
