...
public class RecyclerAdapter5PM extends RecyclerView.Adapter<RecyclerAdapter5PM.TimeViewHolder>{
    ...
    public RecyclerAdapter5PM(List<UserModel> userModelList, Context context, String stringHour) {
