...
public class RecyclerAdapter2PM extends RecyclerView.Adapter<RecyclerAdapter2PM.TimeViewHolder>{
    ...
    public RecyclerAdapter2PM(List<UserModel> userModelList, Context context, String stringHour) {
