...
public class RecyclerAdapter9PM extends RecyclerView.Adapter<RecyclerAdapter9PM.TimeViewHolder>{
    ...
    public RecyclerAdapter9PM(List<UserModel> userModelList, Context context, String stringHour) {
