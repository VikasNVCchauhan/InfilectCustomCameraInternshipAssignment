...
public class RecyclerAdapter8AM extends RecyclerView.Adapter<RecyclerAdapter8AM.TimeViewHolder>{
    ...
    public RecyclerAdapter8AM(List<UserModel> userModelList, Context context, String stringHour) {
