...
public class RecyclerAdapter9AM extends RecyclerView.Adapter<RecyclerAdapter9AM.TimeViewHolder>{
    ...
    public RecyclerAdapter9AM(List<UserModel> userModelList, Context context, String stringHour) {
