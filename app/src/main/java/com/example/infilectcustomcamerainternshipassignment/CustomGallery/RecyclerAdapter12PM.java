...
public class RecyclerAdapter12PM extends RecyclerView.Adapter<RecyclerAdapter12PM.TimeViewHolder> {
    ...
    public RecyclerAdapter12PM(List<UserModel> userModelList, Context context, String stringHour) {
