...
public class RecyclerAdapter2AM extends RecyclerView.Adapter<RecyclerAdapter2AM.TimeViewHolder>{
    ...
    public RecyclerAdapter2AM(List<UserModel> userModelList, Context context, String stringHour) {
