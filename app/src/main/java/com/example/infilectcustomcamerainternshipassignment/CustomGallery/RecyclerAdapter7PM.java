...
public class RecyclerAdapter7PM extends RecyclerView.Adapter<RecyclerAdapter7PM.TimeViewHolder> {
    ...
    public RecyclerAdapter7PM(List<UserModel> userModelList, Context context, String stringHour) {
