...
public class RecyclerAdapter7AM extends RecyclerView.Adapter<RecyclerAdapter7AM.TimeViewHolder>{
    ...
    public RecyclerAdapter7AM(List<UserModel> userModelList, Context context, String stringHour) {
