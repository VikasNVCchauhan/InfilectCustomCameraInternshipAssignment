...
public class RecyclerAdapter6AM extends RecyclerView.Adapter<RecyclerAdapter6AM.TimeViewHolder>{
    ...
    public RecyclerAdapter6AM(List<UserModel> userModelList, Context context, String stringHour) {
