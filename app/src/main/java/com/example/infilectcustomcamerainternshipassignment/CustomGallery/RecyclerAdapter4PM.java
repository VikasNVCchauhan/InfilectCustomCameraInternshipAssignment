...
public class RecyclerAdapter4PM extends RecyclerView.Adapter<RecyclerAdapter4PM.TimeViewHolder>{
    ...
    public RecyclerAdapter4PM(List<UserModel> userModelList, Context context, String stringHour) {
