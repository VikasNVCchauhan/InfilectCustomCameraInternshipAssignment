...
public class RecyclerAdapter11PM extends RecyclerView.Adapter<RecyclerAdapter11PM.TimeViewHolder>{
    ...
    public RecyclerAdapter11PM(List<UserModel> userModelList, Context context, String stringHour) {
