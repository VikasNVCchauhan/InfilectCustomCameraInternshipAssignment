...
public class RecyclerAdapter8PM extends RecyclerView.Adapter<RecyclerAdapter8PM.TimeViewHolder>{
    ...
    public RecyclerAdapter8PM(List<UserModel> userModelList, Context context, String stringHour) {
