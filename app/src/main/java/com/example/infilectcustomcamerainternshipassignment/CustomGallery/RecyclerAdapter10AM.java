...
public class RecyclerAdapter10AM extends RecyclerView.Adapter<RecyclerAdapter10AM.TimeViewHolder>{
    ...
    public RecyclerAdapter10AM(List<UserModel> userModelList, Context context, String stringHour) {
