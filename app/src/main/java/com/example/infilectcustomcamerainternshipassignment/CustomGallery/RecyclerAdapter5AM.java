...
public class RecyclerAdapter5AM extends RecyclerView.Adapter<RecyclerAdapter5AM.TimeViewHolder>{
    ...
    public RecyclerAdapter5AM(List<UserModel> userModelList, Context context, String stringHour) {
